...
const socials = [
  {Icon : FaLinkedin, label: "LinkedIn", href:"https://www.linkedin.com/in/abhinavimmortaldeveloper/"},
  {Icon : FaGithub, label: "GitHub", href:"https://github.com/abhinav1392004"},
  {Icon : SiLeetcode, label: "LeetCode", href:"https://leetcode.com/u/immortal_abhi/"},
]

const glowVarients = {
  initial:{scale:1 , y:0, filter : "drop-shadow(0 0 0 rgb(0,0,0,0))"},
  hover :{
    scale:1.2, y:-3,
    filter: "drop-shadow(0 0 8px rgb(13,88,204,0.9)) drop-shadow(0 0 18px rgb(16, 185, 129, 0.8))",
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              I turned complex ideas inyo samless, high-impact web experiences - building modern, scalable and lightning-fast application that make a difference.
            </motion.p>
