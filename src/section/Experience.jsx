  ...
  if(layout==="desktop"){
    return(
      ...
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        <motion.div className="z-10 w-7 h-7 rounded-full bg-white shadow-[0_0_0_8px_rgba(255, 255, 255, 0.1)] flex-shrink-0"
        style={{scale, opacity}}
        >
        </motion.div>
        ...
        <div className="sticky top-0 h-screen flex flex-col">
          ...
          <div className="flex flex-1 items-center justify-center px-6 pb-10">
            {!isMobile ? (
              ...
              <div className="relative border-l-2 border-white/20 ml-4 pl-4">
                <motion.div
                  className="absolute left-[-2px] top-0 w-[2px] bg-white origin-top"
